...
namespace YW.Manage.BLL
{
    public class Project
    {
        ...
        public Project()
        {
            ...
            StreamReader sr = new StreamReader(HttpContext.Current.Server.MapPath("~/Server.txt"), Encoding.Default);
            String line;
        ...
        public Models.Project GetFirestProject() {
            if (_dictionaryById == null || _dictionaryById.Count == 0)
            {
                return null;
            }
            else {
                return _dictionaryById.Values.ElementAt(0);
            }
        }
