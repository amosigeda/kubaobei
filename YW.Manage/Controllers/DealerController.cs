...
namespace YW.Manage.Controllers
{
    public class DealerController : BaseController
    {
        ...
        [CheckAuthorize]
#pragma warning disable CS0108 // “DealerController.User(int)”隐藏继承的成员“Controller.User”。如果是有意隐藏，请使用关键字 new。
        public ActionResult User(int id)
#pragma warning restore CS0108 // “DealerController.User(int)”隐藏继承的成员“Controller.User”。如果是有意隐藏，请使用关键字 new。
        {
            ViewBag.DealerId = id;
            return View();
        }
